...
const playlist = {
    name: "chill",
    songs: ["puzzle" , "anchor" , "navajo" , "weekend" , "sundown" , "relapse" , "volley"],
    duration: 21
}
console.log(playlist);
playlist.songs.push("my final symphony");
console.log(playlist);
function avgSongDur(list) {
    let avg;
    let count = 0 ;
    for (let i = 0 ; i < list.songs.length ; i++){
        count++
    }
    avg = list.duration / count ; 
    return avg
}
console.log("the average length is " + avgSongDur(playlist));
///
